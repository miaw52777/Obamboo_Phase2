    ...
    <div class="main-menu menu-static menu-light menu-accordion menu-shadow">
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          <li class="nav-item active"><a href="standard_exhibition.php"><i class="icon-android-globe"></i><span class="menu-title">Exhibition</span></a> </li>
    ...
    <div class="content-body">
        ...
        <div class="content-header-left breadcrumbs-left breadcrumbs-top col-md-12 col-xs-12">
          <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="standard_product-structure-display.php">FAC</a> </li>
              <li class="breadcrumb-item active"><a href="standard_exhibition.php"> Exhibition</a> </li>
            </ol>
          </div>
        </div>
      </div>
      <div id="image-gallery" class="card">
        <div class="card-header">
          <h4 class="card-title">Taipei AMPA 2017, visit us at Nangang Exhibition Center, booth I0431A.</h4>
        ...
        <div class="card-body collapse in">
          <div class="card-block">
            <div class="row padding-lr-20">
              <p><img src="https://cloudcdn.taiwantradeshows.com.tw/2018/ampa/banner/ampa-945x130-ch.gif" width="100%"> </p>
              <p>Date: 2017/4/19 ~ 2017/4/22
                Taipei AMPA 2017, visit us at Nangang Exhibition Center, booth I0431A.</p>
              <p>Date: 2017/4/19 ~ 2017/4/22
                Taipei AMPA 2017, visit us at Nangang Exhibition Center, booth I0431A.</p>
              <p>Date: 2017/4/19 ~ 2017/4/22
                Taipei AMPA 2017, visit us at Nangang Exhibition Center, booth I0431A.</p>
