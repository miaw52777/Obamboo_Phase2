								...
								<div class="card-body collapse in">
								  ...
								  <div class="card-block">
									...
									<div class="card-text padding-lr-20 padding-bottom-20 padding-top-20">
									  ...
									  <button class="btn btn-success font-medium-1 percent-width-dialog-btn mt-1" onclick="datasheetDownloadClick()"> CAD download</button>
									  <button class="btn btn-success font-medium-1 percent-width-dialog-btn mt-1" onclick="datasheetMailClick()"> CAD by email</button>
									  <?
										...
										if($cadaction == 'email') echo'<div class="percent-width-dialog" title="常用檔案 歡迎傳遞 :">';
										else echo'<div class="percent-width-dialog" title="常用檔案 歡迎下載 :">';
									?>
