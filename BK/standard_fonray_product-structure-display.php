  ...
  <div class="navbar-wrapper">
    <div class="navbar-header">
      <ul class="nav navbar-nav">
        ...
        <li><a href="standard_fonray_product-structure-list.php" class="navbar-brand nav-link"><img alt="3DHost" src="app-assets/images/logo/3dhost-logo-light.png" class="brand-logo"></a></li>
        ...
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          <li class="nav-item"><a href="standard_fonray_product-structure-list.php"><i class="icon-ios-folder"></i><span data-i18n="nav.dash.main" class="menu-title">Products</span> 
            ...
            <? 
				...
				{	
					// root : leve1 1									
					echo '<li class="active"><a href="standard_fonray_product-structure-list.php" class="menu-item">'.stringWrap($temp['Product_Name']).'</a>';
					$level_cnt = 1;			
                ...
                <div class="card-text">
                  <div class="table-responsive">
                    <table class="table mb-0">
                      ...
                      <form class="form form-horizontal" action="standard_fonray_product-structure-display.php" method="post">
                        <tbody>
                          <?
							if(isset($_POST['id']))
							{							
