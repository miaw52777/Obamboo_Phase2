                  ...
                  <form class="form form-horizontal">
                    <div class="form-body padding-top-40">
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="projectinput1" class="form-control" placeholder="產品名稱" name="category">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="projectinput2">選擇產品類別</label>
                        <div class="col-md-9">
                          <select id="projectinput2" name="interested" class="form-control">
                            <option value="Filter Regulator Lubricator (FRL)">Filter Regulator Lubricator (FRL)</option>
                            <option value="Filter Regulator Lubricator (FRL)">-- Filter Regulator Lubricator</option>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="projectinput3" class="form-control" placeholder="排序" name="no">
                        </div>
                      </div>
                      <div class="form-group row">
              ...
              <div class="card-body collapse in">
                <div class="card-block padding-lr-20 padding-bottom-20 padding-top-20">
                  <div class="btn-group" role="group" aria-label="Basic example">
                    <button type="button" class="btn btn-info" onclick="location.href='specifications.php';">產品規格</button>
                    <button type="button" class="btn btn-danger" onclick="location.href='3d.php';">產品 3D</button>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body collapse in">
                <div class="card-block padding-lr-20 padding-bottom-20 padding-top-20">
                  <form class="form-horizontal" action="#">
                    ...
                    <button id="edit" class="btn btn-warning" type="button"><i class="icon-pencil"></i> 取消</button>
                    <button id="save" class="btn btn-success" type="button"><i class="icon-save"></i> 儲存</button>
                  </form>
                </div>
              </div>
            </div>
