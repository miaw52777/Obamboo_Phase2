...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-bordered menu-shadow">
  <div class="main-menu-content">
    <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
      ...
      <li class="nav-item active"><a href="video.php"><i class="icon-android-film"></i><span class="menu-title">影片介紹</span></a></li>
  ...
  <div class="content-wrapper">
    <div class="content-header row">
      <div class="content-header-left col-md-6 col-xs-12">
        <h2 class="content-header-title mb-0">影片介紹</h2>
        <div class="row breadcrumbs-top">
          <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              <li class="breadcrumb-item active">影片介紹</li>
            </ol>
          </div>
        </div>
      </div>
              ...
              <div class="card-body collapse in">
                ...
                <table class="table table-striped table-bordered">
                  <tbody>
                    ...
                    <tr>
                      <td>上傳影片H.264/MPEG-4 AVC</td>
                      <td><input type="file" name="fileField" id="fileField"></td>
                    </tr>
                    <tr>
                      <td>適用產品</td>
                      <td>列出產品名稱供選擇 併顯示於對應產品前台</td>
                    </tr>
                  </tbody>
                </table>
