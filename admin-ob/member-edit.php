...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-bordered menu-shadow">
  <div class="main-menu-content">
    <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
      ...
      <li class="nav-item active"><a href="member.php"><i class="icon-android-people"></i></i><span class="menu-title">會員管理</span></a></li>
  ...
  <div class="content-wrapper">
    <div class="content-header row padding-bottom-20">
      <div class="content-header-left col-md-6 col-xs-12">
        <h2 class="content-header-title mb-0">會員管理</h2>
        <div class="row breadcrumbs-top">
          <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              <li class="breadcrumb-item active"><a href="member.php">會員管理</a></li>
            </ol>
          </div>
        </div>
      </div>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><span class="col-md-9">
                          <input name="projectinput1" type="text" class="form-control" id="projectinput1" placeholder="">
                        </span></td>
                      </tr>
                      <tr>
                        <td>公司名稱</td>
                        <td><span class="col-md-9">
                          <input name="projectinput2" type="text" class="form-control" id="projectinput2" placeholder="">
                        </span></td>
                      </tr>
                      <tr>
                        <td>E-mail</td>
                      ...
                      <tr>
                        <td>電話</td>
                        <td><span class="col-md-9">
                          <input name="projectinput3" type="text" class="form-control" id="projectinput3" placeholder="">
                        </span></td>
                      </tr>
                      <tr>
                        <td>國家</td>
                        <td><span class="col-md-9">
                          <input name="projectinput4" type="text" class="form-control" id="projectinput4" placeholder="">
                        </span></td>
                      </tr>
                      <tr>
                        <td>密碼</td>
                        <td><span class="col-md-9">
                          <input name="projectinput5" type="text" class="form-control" id="projectinput5" placeholder="">
                        </span></td>
                      </tr>
                      <tr>
                        <td>關注產品</td>
