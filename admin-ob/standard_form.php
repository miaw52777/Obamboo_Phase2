    ...
    <div class="main-menu menu-static menu-light menu-accordion menu-shadow">
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          <li class="nav-item active"><a href="standard_form.php"><i class="icon-mail6"></i><span class="menu-title">Enquiry</span></a> </li>
          ...
          <li class="nav-item active"><a href="standard_video.php"><i class="icon-android-film"></i><span class="menu-title">Video</span></a> </li>
        ...
        <div class="content-header-left breadcrumbs-left breadcrumbs-top col-md-12 col-xs-12">
          <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a href="standard_form.php"><i class="icon-mail6"></i> Enquiry</a> </li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title" id="horz-layout-basic">Enquiry</h4>
              ...
              <div class="card-body collapse in">
                <div class="card-block padding-lr-20">
                  <form class="form form-horizontal">
                    <div class="form-body">
                      <h4 class="form-section"><i class="icon-clipboard4"></i> Products</h4>
                      <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-12">
                          <ul class="list-inline padding-lr-20">
                            <li class="list-inline-item"><a href=""><i class="icon-trash4"></i></a> Products 1</li>
                          </ul>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-12">
                          <ul class="list-inline padding-lr-20">
                            <li class="list-inline-item"><a href=""><i class="icon-trash4"></i></a> Products 2</li>
                          </ul>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-12">
                          <ul class="list-inline padding-lr-20">
                            <li class="list-inline-item"><a href=""><i class="icon-trash4"></i></a> Products 3</li>
                          </ul>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-xl-4 col-lg-4 col-md-12">
                          <ul class="list-inline padding-lr-20">
                            <li class="list-inline-item"><a href=""><i class="icon-trash4"></i></a> Products 4</li>
                          </ul>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-12">
                          <ul class="list-inline padding-lr-20">
                            <li class="list-inline-item"><a href=""><i class="icon-trash4"></i></a> Products 5</li>
                          </ul>
                        </div>
                        <div class="col-xl-4 col-lg-4 col-md-12">
                          <ul class="list-inline padding-lr-20">
                            <li class="list-inline-item"><a href=""><i class="icon-trash4"></i></a> Products 6</li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="projectinput2">Company</label>
                        <div class="col-md-9">
                          <input type="text" id="projectinput2" class="form-control" placeholder="Company" name="company">
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="projectinput5" class="form-control" placeholder="Country" name="country">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="projectinput9">Message</label>
                        <div class="col-md-9">
                          <textarea id="projectinput9" rows="5" class="form-control" name="comment" placeholder="Message"></textarea>
                        </div>
                      </div>
                    </div>
                    <div class="form-actions">
                      <button type="submit" class="btn btn-success"> <i class="icon-check2"></i> Send </button>
                    </div>
                  </form>
                </div>
              </div>
