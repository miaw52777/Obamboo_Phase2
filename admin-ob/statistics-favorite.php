...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-bordered menu-shadow">
  <div class="main-menu-content">
    <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
      ...
      <li class="nav-item active"><a href="statistics-favorite.php"><i class="icon-ribbon"></i><span class="menu-title">關注產品統計</span></a></li>
  ...
  <div class="content-wrapper">
    <div class="content-header row padding-bottom-20">
      <div class="content-header-left col-md-6 col-xs-12">
        <h2 class="content-header-title mb-0">關注產品統計</h2>
        <div class="row breadcrumbs-top">
          <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              <li class="breadcrumb-item active">關注產品統計</li>
            </ol>
          </div>
        </div>
      </div>
