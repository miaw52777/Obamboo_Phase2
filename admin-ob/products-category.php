                  ...
                  <table class="table table-striped table-bordered bootstrap-3">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><button type="button" class="btn btn-success mr-1 mb-1">編輯</button>
                          <button type="button" class="btn btn-warning mr-1 mb-1">刪除</button></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td>2 Way, 2 Position Solenoid Valves</td>
                        <td>1</td>
                        <td>2 Way, 2 Position Solenoid Valves</td>
                        <td><div class="card-block">
                            <div class="icheck1">
                      ...
                      <tr>
                        <td>Manual Valves, Hand Pull Valves</td>
                        <td>1</td>
                        <td>Manual Valves, Hand Pull Valves</td>
                        <td><div class="card-block">
                            <div class="icheck1">
                      ...
                      <tr>
                        <td>Filter Regulator Lubricator</td>
                        <td>2</td>
                        <td>Filter Regulator Lubricator (FRL) / Filter Regulator Lubricator</td>
                        <td><div class="card-block">
                            <div class="icheck1">
                              <fieldset>
                                <input type="checkbox" id="input-2" checked>
