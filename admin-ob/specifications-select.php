        ...
        <div class="row breadcrumbs-top">
          <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="products-edit.php">新增產品</a></li>
              <li class="breadcrumb-item"><a href="specifications.php">產品規格</a></li>
                  ...
                  <form class="form form-horizontal">
                    <div class="form-body padding-top-40">
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="projectinput1" class="form-control" placeholder="產品選項" name="options">
                        </div>
                      </div>
