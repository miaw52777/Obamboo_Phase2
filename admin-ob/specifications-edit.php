                  ...
                  <form class="form form-horizontal">
                    <div class="form-body padding-top-40">
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="projectinput1" class="form-control" placeholder="產品規格" name="specifications">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="projectinput3">單位</label>
                        <div class="col-md-9">
                          <input type="text" id="projectinput3" class="form-control" placeholder="單位" name="unit">
                        </div>
                      </div>
                      <div class="form-group row">
