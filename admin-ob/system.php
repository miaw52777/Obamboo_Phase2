                  ...
                  <table class="table table-striped table-bordered bootstrap-3">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><button type="button" class="btn btn-success">編輯</button></td>
                      </tr>
                      <tr>
                        <td>產品 tag</td>
                        <td><div class="card-block">
                        ...
                        <td><button type="button" class="btn btn-success" onclick="location.href='system-productstag-edit.php';">編輯</button></td>
                      </tr>
                      <tr>
                        <td>會員功能</td>
                        <td><div class="card-block">
                      ...
                      <tr>
                        ...
                        <td><button type="button" class="btn btn-success" onclick="location.href='system-enquiry-edit.php';">編輯</button></td>
                      </tr>
                      <tr>
                        <td>商情中心</td>
                        <td><div class="card-block">
                        ...
                        <td><button type="button" class="btn btn-success" onclick="location.href='system-business-enquiry-edit.php';">編輯</button></td>
                      </tr>
                      <tr>
                        <td>匯入產品規格</td>
                        <td><div class="card-block">
