...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-bordered menu-shadow">
  <div class="main-menu-content">
    <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
      <li class="nav-item active"><a href="products-category.php"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">產品類別</span><span class="tag tag tag-primary tag-pill float-xs-right mr-2">11</span></a> </li>
        ...
        <div class="row breadcrumbs-top">
          <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">新增產品類別</li>
            </ol>
          </div>
        </div>
      </div>
                  ...
                  <form class="form form-horizontal">
                    <div class="form-body padding-top-40">
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="projectinput1" class="form-control" placeholder="產品類別名稱" name="category">
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <select id="projectinput2" name="interested" class="form-control">
                            <option value="none" selected="">* No Parent Category</option>
