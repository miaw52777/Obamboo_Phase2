                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><label id="projectinput8" class="file center-block">
                            ...
                            <span class="file-custom"></span> </label></td>
                        <td><button type="submit" class="btn btn-success" /> <i class="icon-check2"></i> 儲存</td>
                        <td><progress value="50" max="100" class="progress progress-info mb-0">50%</progress></td>
                        <td><button type="button" class="btn" onclick="location.href='download.php';">Download 檔案</button></td>
                      </tr>
                ...
                <div class="card-block card-dashboard padding-lr-20">
                  <table class="table table-striped table-bordered bootstrap-3">
                    ...
                    <tbody>
                      <tr>
                        <td>Bore - 32<br>
                          Motion - Double Acting<br>
                          Mounting Type - Standard Type <br>
                          Operating Speed - 50~500<br>
                          Working-pressure Range - 0.15~0.9</td>
                        <td><label id="projectinput8" class="file center-block">
                            <input type="file" id="file">
                            <span class="file-custom"></span> </label></td>
