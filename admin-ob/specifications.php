...
<div class="app-content content container-fluid">
  <div class="content-wrapper">
    ...
    <div>
      <button type="button" class="btn btn-info mr-1 mb-1" onclick="location.href='specifications-edit.php';"><i class="icon-plus4"></i> 新增產品規格</button>
    </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><div class="btn-group" role="group" aria-label="Basic example">
                            <button type="button" class="btn btn-success" onclick="location.href='specifications-edit.php';">編輯</button>
                            <button type="button" class="btn btn-info" onclick="location.href='specifications-select.php';">產品選項</button>
                      ...
                      <tr>
                        ...
                        <td><div class="btn-group" role="group" aria-label="Basic example">
                            ...
                            <button type="button" class="btn btn-info">產品選項</button>
                            <button type="button" class="btn btn-warning">刪除</button>
                          </div></td>
                      </tr>
                      <tr>
