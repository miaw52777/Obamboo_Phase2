    ...
    <div class="main-menu menu-static menu-light menu-accordion menu-shadow">
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          <li class="nav-item"><a href="standard_product-structure-list.php"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Products</span> 
              ...
              <li><a href="standard_product-structure-list-2.php" class="menu-item">Filter Regulator<br>
                ...
                <ul class="menu-content">
                  <li><a href="standard_product-structure-list-3.php" class="menu-item">Filter Regulator<br>
                    Lubricator</a>
                    <ul class="menu-content">
                      <li class="active txt-green"><a href="standard_product-structure-display.php" class="menu-item txt-green">FAC</a></li>
    ...
    <div class="content-body">
      <div class="content-header row">
        <div class="content-header-left breadcrumbs-left breadcrumbs-top col-md-12 col-xs-12">
          <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="standard_product-structure-list.php"><i class="icon-home3"></i> Products</a> </li>
              <li class="breadcrumb-item"><a href="standard_product-structure-list-2.php">Filter Regulator Lubricator (FRL)</a> </li>
              <li class="breadcrumb-item"><a href="standard_product-structure-list-3.php">Filter Regulator Lubricator</a> </li>
              <li class="breadcrumb-item active"><a href="standard_product-structure-display.php">FAC</a> </li>
            </ol>
          </div>
        </div>
      </div>
                ...
                <div class="card-text">
                  <div class="table-responsive">
                    ...
                    <div class="padding-top-30 padding-lr-20 padding-bottom-20 ">
                      ...
                      <button class="ui-button ui-widget ui-corner-all btn-success" onclick="location.href='standard_form.php';"><span class="ui-icon icon-mail6"></span> Add enquiry</button>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title" id="from-actions-bottom-right">Video</h4>
              <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
              <div class="heading-elements">
                <ul class="list-inline mb-0">
                  <li><a data-action="collapse"><i class="icon-minus4"></i></a></li>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title" id="from-actions-bottom-right">tag</h4>
              <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
              <div class="heading-elements">
                <ul class="list-inline mb-0">
                  <li><a data-action="collapse"><i class="icon-minus4"></i></a></li>
...
<script>
	...
	$(document).ready(function(){
		$.post('url-131.php', {s:"<?php echo $_SESSION[getRequestIP().'_'.$o]; ?>",o:"<?php echo $o; ?>"}, function(data) {
