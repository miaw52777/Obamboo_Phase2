        ...
        <div class="content-header-left breadcrumbs-left breadcrumbs-top col-md-12 col-xs-12">
          <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a href="standard_exhibition.php"><i class="icon-android-globe"></i> Exhibition</a> </li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-xl-12 col-lg-12 col-md-12">
            <div class="row">
              <div class="col-xl-3 col-lg-4 col-md-12">
                <div class="card">
                  <div class="card-body">
                    <div class="carousel-inner"> <a href="standard_exhibition-view.php"><img src="demo/exhibition.jpg" alt="" class="img-responsive"></a> </div>
                    <div class="card-block">
                      <h5 class="card-title txtheight2"><a href="standard_exhibition-view.php">Taipei AMPA 2017, visit us at Nangang Exhibition Center</a></h5>
                      <p class="txt">Date: 2017/4/19 ~ 2017/4/22 <br>
                        Taipei AMPA 2017, visit us at Nangang Exhibition Center</p>
                    </div>
                  </div>
                </div>
              </div>
