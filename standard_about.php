        ...
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          <li class="nav-item"><a href="standard_product-structure-list.php"><i class="icon-ios-folder"></i><span data-i18n="nav.dash.main" class="menu-title">Products</span> 
            ...
            <ul class="menu-content">
              <li><a href="standard_product-structure-list-2.php" class="menu-item">Filter Regulator<br>
                Lubricator (FRL)</a>
                <ul class="menu-content">
          ...
          <li class="nav-item active"><a href="standard_about.php"><i class="icon-office"></i><span class="menu-title">About</span></a> </li>
        ...
        <div class="content-header-left breadcrumbs-left breadcrumbs-top col-md-12 col-xs-12">
          <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a href="standard_about.php"><i class="icon-office"></i> About</a> </li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="card-body collapse in">
          <div class="card-block">
            <div class="row padding-lr-20">
              <p>Founded in 1992, FONRAY ENTERPRISE CO., LTD is an experienced and leading valves manufacturer in pneumatic field. Our main goals are provide customers high quality products at competitive prices. To achieve our goal, we have patented the ISO9001 Registration and CE certification. We also do our best to make innovations in our products in order to offer high qualities and outstanding designs to customers.</p>
              <p>FONRAY supplies plenty of pneumatic products throughout the world, such as solenoid valves, air cylinders, pneumatic units, fittings &amp; tubes, vacuum ejectors, pilot check valves, and so on. Please browse our website for details or contact us directly.</p>
              <p>Some products and their advantages are introduced as below:</p>
              <p>Pneumatic Fitting: Our air fittings differ from other company's fittings. In generally, air fittings can only be used in PU tube. We use viton seal rings instead of air seal rings, so the fitting can be used in the air, oil and water medium with PU tube and Nylon tube.</p>
              <p>The 4V solenoid valve: We use Japanese seal ring and metal piston instead of plastic piston. Unlike other companies, they usually use plastic piston. Our working valve is quicker and only weighed 0.5 kg, so the axle center will work smoother. Our valve has long service life, too.</p>
              <p>The FSY solenoid valve: We use the coil with only 0.15W electric current. It can reach the need of high frequency users that is not easy to get heat.<br>
              </p>
            </div>
          </div>
        </div>
