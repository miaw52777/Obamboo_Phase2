...
<div id="fullscreen-search" class="fullscreen-search">
  ...
  <span class="fullscreen-search-close"></span> </div>
    ...
    <div class="main-menu menu-static menu-light menu-accordion menu-shadow">
      <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
          ...
          <li class="nav-item active"><a href="standard_product-structure-list.php"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Products</span> 
            <!--<span class="tag tag tag-primary tag-pill float-xs-right mr-2">5</span>--> 
            </a>
            <ul class="menu-content">
              <li class=""><a href="standard_product-structure-list-2.php" class="menu-item">Filter Regulator<br>
                Lubricator (FRL)</a>
                <ul class="menu-content">
                  <li><a href="standard_product-structure-list-3.php" class="menu-item">Filter Regulator<br>
                    Lubricator</a>
                    <ul class="menu-content">
                      <li><a href="standard_product-structure-display.php" class="menu-item">FAC</a></li>
        ...
        <div class="content-header-left breadcrumbs-left breadcrumbs-top col-md-12 col-xs-12">
          <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"><a href="standard_product-structure-list.php"><i class="icon-home3"></i> Products</a> </li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="col-xs-12">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">Full Show of Our 3D Assets</h4>
            ...
            <div class="row padding-top-30 padding-lr-20">
              <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="row">
                  <div class="col-xl-3 col-lg-4 col-md-12">
                    <div class="card">
                      <div class="card-body">
                        <div class="carousel-inner"> <a href="standard_product-structure-list-2.php"><img src="demo/fonray/filter-regulator-lubricator-FAC001.jpg" alt="" class="img-responsive"></a> </div>
                        <div class="card-block">
                          <h5 class="card-title txtheight"><a href="standard_product-structure-list-2.php">Filter Regulator Lubricator (FRL)</a></h5>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-3 col-lg-4 col-md-12">
                    <div class="card">
                      <div class="card-body">
                        <div class="carousel-inner"> <a href="standard_product-structure-list-2.php"><img src="demo/fonray/3V-01.jpg" alt="" class="img-responsive"></a> </div>
                        <div class="card-block">
                          <h5 class="card-title txtheight"><a href="standard_product-structure-list-2.php">Solenoid Valves</a></h5>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-3 col-lg-4 col-md-12">
                    <div class="card">
                      <div class="card-body">
                        <div class="carousel-inner"> <a href="standard_product-structure-list-2.php"><img src="demo/fonray/2W2S.jpg" alt="" class="img-responsive"></a> </div>
                        <div class="card-block">
                          <h5 class="card-title txtheight"><a href="standard_product-structure-list-2.php">2 Way, 2 Position Solenoid Valves</a></h5>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-3 col-lg-4 col-md-12">
                    <div class="card">
                      <div class="card-body">
                        <div class="carousel-inner"> <a href="standard_product-structure-list-2.php"><img src="demo/fonray/401.jpg" alt="" class="img-responsive"></a> </div>
                        <div class="card-block">
                          <h5 class="card-title txtheight"><a href="standard_product-structure-list-2.php">Manual Valves, Hand Pull Valves</a></h5>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-3 col-lg-4 col-md-12">
                    <div class="card">
                      <div class="card-body">
                        <div class="carousel-inner"> <a href="standard_product-structure-list-2.php"><img src="demo/fonray/fv-320.jpg" alt="" class="img-responsive"></a> </div>
                        <div class="card-block">
                          <h5 class="card-title txtheight"><a href="standard_product-structure-list-2.php">Foot Valves</a></h5>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-3 col-lg-4 col-md-12">
                    <div class="card">
                      <div class="card-body">
                        <div class="carousel-inner"> <a href="standard_product-structure-list-2.php"><img src="demo/fonray/machanical-valve-MV301.jpg" alt="" class="img-responsive"></a> </div>
                        <div class="card-block">
                          <h5 class="card-title txtheight"><a href="standard_product-structure-list-2.php">Mechanical Valves</a></h5>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-3 col-lg-4 col-md-12">
                    <div class="card">
                      <div class="card-body">
                        <div class="carousel-inner"> <a href="standard_product-structure-list-2.php"><img src="demo/fonray/cylinder-ASC.jpg" alt="" class="img-responsive"></a> </div>
                        <div class="card-block">
                          <h5 class="card-title txtheight"><a href="standard_product-structure-list-2.php">Standard Cylinders</a></h5>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-3 col-lg-4 col-md-12">
                    <div class="card">
                      <div class="card-body">
                        <div class="carousel-inner"> <a href="standard_product-structure-list-2.php"><img src="demo/fonray/EPC-S.jpg" alt="" class="img-responsive"></a> </div>
                        <div class="card-block">
                          <h5 class="card-title txtheight"><a href="standard_product-structure-list-2.php">Pneumatic Fittings</a></h5>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-3 col-lg-4 col-md-12">
                    <div class="card">
                      <div class="card-body">
                        <div class="carousel-inner"> <a href="standard_product-structure-list-2.php"><img src="demo/fonray/punch-app-100A.jpg" alt="" class="img-responsive"></a> </div>
                        <div class="card-block">
                          <h5 class="card-title txtheight"><a href="standard_product-structure-list-2.php">APP Punch</a></h5>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-3 col-lg-4 col-md-12">
                    <div class="card">
                      <div class="card-body">
                        <div class="carousel-inner"> <a href="standard_product-structure-list-2.php"><img src="demo/fonray/vacuum-jectors-pad01.jpg" alt="" class="img-responsive"></a> </div>
                        <div class="card-block">
                          <h5 class="card-title txtheight"><a href="standard_product-structure-list-2.php">Fluctuation Flat</a></h5>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="col-xl-3 col-lg-4 col-md-12">
                    <div class="card">
                      <div class="card-body">
                        <div class="carousel-inner"> <a href="standard_product-structure-list-2.php"><img src="demo/fonray/pilot-check-valves.jpg" alt="" class="img-responsive"></a> </div>
                        <div class="card-block">
                          <h5 class="card-title txtheight"><a href="standard_product-structure-list-2.php">Other Parts</a></h5>
                        </div>
                      </div>
                    </div>
                  </div>
