...
//var_dump($item_id);
// menu count level 1 of product category
$queryResult = get_Products_Category_List('%');
$LevelRootCnt = getLevel1CategoryCount($queryResult);


// get specification items record by spec_id
$rule = get_ProductSpecItem_Select_Rule('ITEM_ID',$item_id);	
$queryItemresult = get_ProductSpecItem_List($rule);

$spec_item_name = getSQLResultInfo($queryItemresult,'item');
$spec_item_seq = getSQLResultInfo($queryItemresult,'seq');
...
<form class="form-horizontal" action="specifications-select-submit.php" method="post">
...
<div class="app-content content container-fluid">
  <div class="content-wrapper">
        ...
        <div class="row breadcrumbs-top">
          <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="products-edit.php?"<? echo 'id='.$prod_cat_id.'&prod_id='.$prod_id; ?> >編輯產品</a></li>
              <li class="breadcrumb-item"><a href="specifications.php?<? echo 'id='.$prod_cat_id.'&prod_id='.$prod_id; ?>">產品規格</a></li>
              <li class="breadcrumb-item active">產品規格選項</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <div>
      <button type="button" class="btn btn-info mr-1 mb-1"><i class="icon-plus4"></i> 新增產品規格選項</button>
    </div>
          ...
          <div class="col-xs-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title"><? echo $Action; ?>產品規格選項</h4>
                  ...
                  <form class="form form-horizontal">
                    <div class="form-body padding-top-40">
                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="projectinput1">規格選項</label>
                        <div class="col-md-9">
                          <input type="text" id="projectinput1" class="form-control" placeholder="產品選項" name="item" value="<? echo $spec_item_name; ?>">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" id="projectinput3" class="form-control" placeholder="排序" name="no" value="<? echo $spec_item_seq; ?>">
                        </div>
                      </div>
                    ...
                    <div class="form-actions">
					  ...
					  ?>
					   ...
					   <? 
						 ...
						 echo '<input type="hidden" name="id" value="'.$prod_cat_id.'"/>';
						 echo '<input type="hidden" name="prod_id" value="'.$prod_id.'"/>';
						 echo '<input type="hidden" name="s_id" value="'.$spec_id.'"/>';
