...
<div class="app-content content container-fluid">
  <div class="content-wrapper">
        ...
        <div class="row breadcrumbs-top">
          <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="products-edit.php?<? echo 'id='.$ProductCategoryID.'&prod_id='.$Product_id.'&s_id='.$spec_id.'&action='.$Action; ?>">編輯產品</a></li>
    ...
    <div>
	 <?
      echo '<button type="button" class="btn btn-info mr-1 mb-1" onclick="location.href=\'specifications-edit.php?action=新增&id='.$ProductCategoryID.'&prod_id='.$Product_id.'\';"><i class="icon-plus4"></i> 新增產品規格</button>';
	 ?> 
    </div>
                ...
                <div class="card-block card-dashboard padding-lr-20">
                  <table class="table table-striped table-bordered bootstrap-3">
                    ...
                    <tbody>
					  ...
					  <?
							$rule = get_ProductSpec_Select_Rule('ID',$Product_id);
							...
							{	
								...
								$param = 'id='.$ProductCategoryID.'&prod_id='.$Product_id.'&s_id='.$temp['s_id'];
								$tmplateForlist = '<tr>
													<td>:SPEC_NAME</td>
													<td>:SPEC_ITEM_CNT</td>														
													<td><div class="btn-group" role="group" aria-label="Basic example">
														<button type="button" class="btn btn-success" onclick="location.href=\'specifications-edit.php?'.$param.'&action=編輯\';">編輯</button>
														<button type="button" class="btn btn-info" onclick="location.href=\'specifications-select.php?'.$param.'\';">產品選項</button>
														<button type="button" class="btn btn-warning" onclick="location.href=\'specifications-edit.php?'.$param.'&action=刪除\';">刪除</button>															
													  </div></td>
												  </tr>';
										
										
								$sourceStr = array(":SPEC_NAME", ":SPEC_ITEM_CNT");
								$replaceStr   = array($temp['name'],$temp['item_cnt']);
