        ...
        <div class="col-md-4 offset-md-4 col-xs-10 offset-xs-1 box-shadow-3 p-0">
          <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
            <div class="card-header no-border">
              <div class="card-title text-xs-center"> <img src="../app-assets/images/logo/3dhost-logo-light.png" alt=""> </div>
            </div>
            <div class="card-body collapse in">
              <p class="card-subtitle line-on-side text-muted text-xs-center font-small-3 mx-2 my-1"><span>Account Details</span></p>
              <div class="card-block">
                <form class="form-horizontal" action="adchecklogin.php" method="post" novalidate>
                  ...
                  <button type="submit" class="btn btn-outline-success btn-block"><i class="icon-unlock2"></i> Login</button>
		  <? 
