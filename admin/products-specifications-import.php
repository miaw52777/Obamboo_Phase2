...
<link rel="stylesheet" type="text/css" href="../assets/css/style.css"><script type="text/javascript">function GetProductlist(rootName){		if (rootName != "") 	{         				window.location.href = "products-specifications-import.php?q="+rootName;			}	}</script>
</head>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <select id="prod_id" name="prod_id" class="form-control">
							<?																$prod_id_options = getProductList($prod_cat_id);								echo $prod_id_options;								 							?>
                          </select>
                        </div>
                      </div>
                      <div class="form-group row">
