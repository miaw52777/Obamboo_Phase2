...
// get specification record by spec_id
$rule = get_ProductSpec_Select_Rule('S_ID',$spec_id);	
$querySpecresult = get_ProductSpec_List($rule);

$spec_name = getSQLResultInfo($querySpecresult,'name');
$spec_seq = getSQLResultInfo($querySpecresult,'seq');
$spec_unit = getSQLResultInfo($querySpecresult,'unit');
?>
...
<form class="form-horizontal" action="specifications-edit-submit.php" method="post">
        ...
        <div class="row breadcrumbs-top">
          <div class="breadcrumb-wrapper col-xs-12">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="products-edit.php?<? echo 'id='.$Product_id.'&s_id='.$spec_id.'&action='.$Action; ?>">編輯產品</a></li>
              <li class="breadcrumb-item active">產品規格</li>
            </ol>
          </div>
        </div>
      </div>
                  ...
                  <form class="form form-horizontal">
                    <div class="form-body padding-top-40">
                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="projectinput1">產品規格</label>
                        <div class="col-md-9">
                          <input type="text" id="projectinput1" class="form-control" placeholder="產品規格" name="specifications" value="<? echo $spec_name; ?>">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="projectinput3">單位</label>
                        <div class="col-md-9">
                          <input type="text" id="projectinput3" class="form-control" placeholder="單位" name="unit" value="<? echo $spec_unit; ?>">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-md-3 label-control" for="projectinput3">排序</label>
                        <div class="col-md-9">
                          <input type="text" id="projectinput3" class="form-control" placeholder="排序" name="no" value="<? echo $spec_seq; ?>">
                        </div>
                      </div>
                    </div>
