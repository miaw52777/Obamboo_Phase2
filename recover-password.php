            ...
            <div class="card-body collapse in">
              <div class="card-block">
                <form class="form-horizontal" action="login-simple.html" novalidate>
                  ...
                  <button type="submit" class="btn btn-success btn-lg btn-block"><i class="icon-lock4"></i> Recover Password</button>
                </form>
              </div>
            </div>
            <div class="card-footer no-border">
              <p class="float-sm-left text-xs-center"><a href="login.php" class="card-link">Login</a></p>
              <p class="float-sm-right text-xs-center">New to 3DHost ? <a href="register.php" class="card-link">Create Account</a></p>
            </div>
          </div>
        </div>
      </section>
